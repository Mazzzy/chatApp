...
// Express code for client
var express = require('express');
var app = express();

// set the port of our application for client
        ...
        if (userName !== false && userColor !== false) {
           ...
           for (var i = 0; i < clients.length; i ++) {
             if ((connection.remoteAddress == clients[i].remoteAddress)
               && (connection.socket._peername.port == clients[i].socket._peername.port)) { //compare remote address to remove from the disconnecting client
                     clients.splice(i, 1);
                }
           }
